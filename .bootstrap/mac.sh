...
brew cask install firefox iterm2 virtualbox karabiner-elements hammerspoon ableton-live-standard musescore surge-synthesizer whatsapp vlc soulseek mactex discord zulip zoom
